    ...
    <div className={`fixed inset-0 bg-zinc-950 transition-opacity duration-300 z-40 ${isOpen ? "opacity-25 visible transition duration-300" : "opacity-0 invisible transition duration-300"}`}/>
      <aside className={`fixed top-0 right-0 h-screen w-80 bg-zinc-900 text-white z-50 ease-in-out transition-transform duration-300 ${ isOpen ? "transition duration-300 translate-x-0" : "transition duration-300 translate-x-full"}`}>
        ...
        <ul className='flex flex-col gap-8 m-8 border-spacing-2'>
          <li className="text-center filter text-2xl">
            <button className="relative pb-1 p-2 px-12 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-full after:origin-bottom-left after:scale-x-0 after:bg-white cursor-pointer after:transition-transform after:duration-500 after:ease-out hover:after:scale-x-100" onClick={() => router.push("/")}>
              Portfolio
            </button>
          </li>
          <li className="text-center filter text-2xl">
            <button className="relative pb-1 p-2 px-12 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-full after:origin-bottom-left after:scale-x-0 after:bg-white cursor-pointer after:transition-transform after:duration-500 after:ease-out hover:after:scale-x-100" onClick={() => router.push("/projetos")} >
              Projetos
            </button>
          </li>
          <li className="text-center filter text-2xl">
            <button className="gap-20 relative pb-1 p-2 px-12 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-full after:origin-bottom-left after:scale-x-0 after:bg-white cursor-pointer after:transition-transform after:duration-500 after:ease-out hover:after:scale-x-100" onClick={() => router.push("/contatos")}>
              Contatos
            </button>
          </li>
          <li className=" text-center filter text-2xl ">
            <button className="relative pb-1 p-2 px-12 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-full after:origin-bottom-left after:scale-x-0 after:bg-white cursor-pointer after:transition-transform after:duration-500 after:ease-out hover:after:scale-x-100">
              About me
            </button>
          </li>
      ...
      <main id='projetos' className='h-200 m-6 flex'>
        <ul className='flex flex-wrap h-min gap-8 '>
          <li className='relative flex h-80 rounded-full'>
            <Link className="flex flex-col w-full gap-8 text-xl h-80 p-4 items-center cursor-default border-b border-b-transparent transition-all duration-300 hover:ease-out hover:border-white hover:bg-zinc-700 hover:rounded-none" href={"https://sitegoop01.vercel.app/"} >
